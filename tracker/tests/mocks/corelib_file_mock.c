...
// Minimal mock implementations for tests that don't need file I/O
// Tests that need real file I/O should use corelib_file_stdio instead

int fileOpen(const char* path, int isWriting) { return -1; }
int fileClose(int fileId) { return -1; }
